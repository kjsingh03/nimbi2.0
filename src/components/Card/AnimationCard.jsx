            ...
            <div className="phase">
                <ul className='md:h-[18rem] list-none z-40 text-sm flex flex-col relative font-["Inter"] gap-3 w-[293px] lg:w-[90%] font-medium px-12 xs:px-6 sm:px-6 md:px-0 md:mx-auto'>
                    ...
                    }
                    {
                        status === 'completed' &&
                        <>
                            <img src={round} className="w-8 h-8 absolute -top-[8.5rem] -left-4 xxs:-left-8 xs:-left-8 md:left-[0rem] md:top-[19rem] 3xl:top-[19rem] z-[100] " />
                            <img src={ellipse} className="w-16 h-16 xs:w-[5rem] xs:h-[5rem] absolute -left-8 xxs:-left-12 -top-[9.5rem] xs:-left-[3.6rem] xs:-top-[9.9rem] md:top-[17.5rem] md:-left-[1.6rem] 3xl:top-[17.5rem] z-[100] " />
                            {/* <svg className={`w-[75rem] rotate-90 md:rotate-0 absolute -top-[47rem] md:top-[17.7rem] 3xl:top-[17.75rem] -left-[37.5rem] xxs:-left-[38.5rem] xs:-left-[38.45rem] md:-left-[75rem] z-10`} viewBox="0 0 1920 115" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <svg className={`block w-[395rem] rotate-90 absolute -top-[23rem] -left-[200.5rem] xxs:-left-[201.6rem] xs:-left-[201.45rem] md:rotate-0 md:top-[11.1rem] 3xl:top-[11.17rem] -z-40`} viewBox="0 0 1920 115" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    }
                    {
                        status !== 'completed' &&
                        <>
                            <img src={icon} className="w-8 h-8 absolute -top-[8.5rem] -left-4 xxs:-left-8 xs:-left-8 md:left-[0rem] md:top-[19rem] 3xl:top-[19rem] z-[100] " />
                            <svg className={`w-[75rem] rotate-90 md:rotate-0 absolute -top-[46.75rem] md:top-[17.7rem] 3xl:top-[17.75rem] -left-[37.5rem] xxs:-left-[38.5rem] xs:-left-[38.5rem] md:-left-[75rem] -z-50`} viewBox="0 0 1920 115" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g filter='url(#filter1_d_1261_1133)'>
                                    <rect className='z-10' width='100%' y="55" height="150" fill="#33BDEB" />
                                </g>
                            </svg>
