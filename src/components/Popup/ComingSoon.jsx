...
function ComingSoon({ setComingSoon, topHeight, comingSoon }) {
    ...
    return (
        <div className={`z-[10000] fixed w-screen h-screen top-0 left-0 font-roboto text-[24px] uppercase flex justify-center items-center bg-[rgb(0,0,0,0.4)]`} style={{ top: 0, position: "sticky" }} onClick={() => setComingSoon("")}>
            <div className="h-[200px] max-w-[400px] w-[80%] bg-[#242D32] relative z-[100]" onClick={(e) => { e.stopPropagation() }}>
